import {
  ...
  validateResponse
} from "./chunk-V2X2IHOJ.js";
import {
  MethodOptions_IdempotencyLevel
} from "./chunk-VTLYC4EG.js";
...
function requestHeader2(useBinaryFormat, timeoutMs, userProvidedHeaders, setUserAgent) {
  ...
  userAgent = result.has(headerUserAgent) ? result.get(headerUserAgent) : result.has(headerXUserAgent) ? result.get(headerXUserAgent) : userAgent;
