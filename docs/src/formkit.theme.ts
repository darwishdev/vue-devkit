...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:button__input": {
    ...
    "group-data-[prefix-icon]:ps-5": true,
    "group-data-[suffix-icon]:pe-5": true,
    "focus:ring-2": true,
  ...
  "family:dropdown__input": {
    ...
    "outline-none": true,
    "bg-transparent": true,
    "group-data-[prefix-icon]:!ps-0": true,
    "group-data-[suffix-icon]:!pe-0": true,
    "border-none": true,
    "focus:ring-0": true,
    "dark:text-neutral-100": true
  },
  ...
  "select__selectIcon": {
    ...
    "pointer-events-none": true,
    "start-2": true,
    "group-data-[suffix-icon]:me-[1.5em]": true,
    "dark:text-neutral-100": true
  },
  "select__optGroup": {
    "group/optgroup": true,
  ...
  "colorpicker__panel": {
    ...
    "[@media(max-width:431px)_and_(hover:none)]:group-[&:not([data-inline])]:start-0": true,
  ...
  "colorpicker__swatch": {
    ...
    "data-[active=true]:after:1/2": true,
  ...
  "toggle__track": {
    ...
    "peer-checked:[&>div:last-child]:full": true,
    "peer-checked:[&>div:last-child]:-translate-x-full": true,
    "peer-checked:[&>div:first-child:not(:last-child)]:start-0": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:after:[calc(50%+0.5em)]": true,
  ...
  "multi-step__badge": {
    ...
    "group-data-[tab-style=tab]/wrapper:start-1.5": true,
