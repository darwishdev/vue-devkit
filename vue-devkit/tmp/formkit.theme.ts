...
/**
  ...
  *
  * @checksum - 44eeffa75e8374d389512b78345c5fb5514f53e2c101ad3fd50adeee5d0374f4
  * @variables - radius=rounded-xl,accentColor=cyan,colorTemperature=neutral,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=200,borderShadeDarkMode=700,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-neutral-200": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=tab]/wrapper:border-neutral-100": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-neutral-800": true,
